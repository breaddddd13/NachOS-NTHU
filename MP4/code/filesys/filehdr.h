...
#define NumDirect ((SectorSize - 2 * sizeof(int)) / sizeof(int)) // 128 - numBytes(4) - numSectors(4) => 120 / pointer(4) => 30
#define MaxFileSize (NumDirect * SectorSize) // 30 * 128 = 3840 bytes
